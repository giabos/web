...
class Card extends HTMLElement {
    ...
    connectedCallback() {
        this.shadowRoot.replaceChildren(style("@import url('./card.css');"), article({ class: "card" }, img({ src: this.#attr("imgUrl") }), footer(div(h4(this.#attr("title")), slot()), p(this.#attr("description")))));
    }
}
